    ...
    class LookupModel
    {
        ...
        public function getList($filters = "", $order = "l.id ASC") {
            ...
            $result = $GLOBALS['db']->query(
                "SELECT l.id, ty.name as tyn, le.name as len, cat.name as catn, ch.name as chn, pos.name as pn, fp.name as fpn, s.name as sn
                FROM lookup l 
                ...
                LEFT JOIN fixtur_position fp ON f.fixture_position_id = fp.id
