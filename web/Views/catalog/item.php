...
<body>
    ...
    <div class="container">
        ...
        <form action="save" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="location" class="form-control" value="<?php if ($id != "") { echo $item['location']; } ?>">
            </div>
            <div class="form-group">
                <label for="status">Status:</label>
                <select id="status" class="form-control" name="status">
                    <?php echo $this->controller->displayStatusList(); ?>
                </select>
            </div>
            <div class="form-group">
                <label for="image">Image:</label>
                <input type="text" name="image" class="form-control" value="<?php if ($id != "") { echo $item['image']; } ?>">
            </div>
            <div class="form-group">
                <label for="description">Description:</label>
                <textarea name="description" class="form-control"><?php if ($id != "") { echo $item['description']; } ?></textarea>
            </div>
    ...
    <script>
        ...
        SelectElement("status", <?php 
                      if ($id != "") { 
                          echo $item['catalog_status_id']; 
                      } ?>);
